...
설계·아키텍처·결정 대장(D1~D14)·세션 기록은 [docs/DESIGN.md](docs/DESIGN.md)에서
관리합니다 — 이 프로젝트의 "왜"가 담긴 정본입니다. 진행 단계(지금 작업·대기열·
완료 기록)는 [docs/PROGRESS.md](docs/PROGRESS.md)에서 추적하고, 단계별 여정을
풀어 쓴 기록은 [docs/MILESTONES.md](docs/MILESTONES.md)에 있습니다.

> Design, architecture, the decision ledger (D1–D14), and session records live in
...
> [docs/PROGRESS.md](docs/PROGRESS.md), and a readable milestone-by-milestone
> journey is written up in [docs/MILESTONES.md](docs/MILESTONES.md).
